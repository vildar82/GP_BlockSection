...
namespace GP_BlockSection.Sections
{
    ...
    public class TableSecton
    {
        ...
        private Table getTable(Database db)
        {
            ...
            table.SetSize(13, data.SectionTypes.Count + 1);
            ...
            table.Cells[6, 0].TextString = "Всего площадь жилого фонда, м.кв.";
            table.Cells[6, 0].Borders.Bottom.LineWeight = LineWeight.LineWeight030;
            table.Cells[7, 0].TextString = "Всего площадь квартир, м.кв.";
            table.Cells[7, 0].Borders.Bottom.LineWeight = LineWeight.LineWeight030;
            table.Cells[8, 0].TextString = "Всего площадь БКФН, м.кв.";
            table.Cells[8, 0].Borders.Bottom.LineWeight = LineWeight.LineWeight030;
            table.Cells[9, 0].TextString = "ДОО, чел";
            table.Cells[9, 0].Borders.Bottom.LineWeight = LineWeight.LineWeight030;
            table.Cells[10, 0].TextString = "СОШ, чел";
            table.Cells[10, 0].Borders.Bottom.LineWeight = LineWeight.LineWeight030;
            table.Cells[11, 0].TextString = @"Машиноместа, м/м 420/1000"; // "\\A1;\\pxt8;Машиноместа, м/м\\P\\ptz;{\\H0.6x;420/1 000}"
            table.Cells[11, 0].Borders.Bottom.LineWeight = LineWeight.LineWeight030;
            table.Cells[12, 0].TextString = "Машиноместа гостевые, м/м (25%)";
            table.Cells[12, 0].Borders.Bottom.LineWeight = LineWeight.LineWeight030;
            ...
            table.Cells[6, 1].TextString = (data.TotalAreaApart + data.TotalAreaBKFN).ToString("0.0");
            table.Cells[6, 1].Borders.Bottom.LineWeight = LineWeight.LineWeight030;
            // ВСЕГО ПЛОЩАДЬ КВАРТИР
            table.Cells[7, 1].TextString = data.TotalAreaApart.ToString("0.0");
            table.Cells[7, 1].Borders.Bottom.LineWeight = LineWeight.LineWeight030;
            // ВСЕГО ПЛОЩАДЬ БКФН
            table.Cells[8, 1].TextString = data.TotalAreaBKFN.ToString("0.0");
            table.Cells[8, 1].Borders.Bottom.LineWeight = LineWeight.LineWeight030;
            //ДОО, чел
            table.Cells[9, 1].TextString = (data.TotalAreaApart* 0.00325).ToString("0.0"); //(("Всего площадь квартир"/20)/1 000)*65
            table.Cells[9, 1].Borders.Bottom.LineWeight = LineWeight.LineWeight030;
            //СОШ, чел
            table.Cells[10, 1].TextString = (data.TotalAreaApart * 0.00675).ToString("0.0");//  (("Всего площадь квартир"/20)/1 000)*135
            table.Cells[10, 1].Borders.Bottom.LineWeight = LineWeight.LineWeight030;
            //Машиноместа, м/м
            var mm = data.TotalAreaApart * 0.021;
            table.Cells[11, 1].TextString = mm.ToString("0.0");//  (("Всего площадь квартир"/20)/1 000)*420
            table.Cells[11, 1].Borders.Bottom.LineWeight = LineWeight.LineWeight030;
            //Машиноместа гостевые, м/м
            table.Cells[12, 1].TextString = (mm * 0.25).ToString("0.0");//  Машиноместа %25
            table.Cells[12, 1].Borders.Bottom.LineWeight = LineWeight.LineWeight030;
